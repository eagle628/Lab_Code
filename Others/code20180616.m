...
Ts = 0.01;
t = (0:N-1)'*Ts;
cn1 = dsp.ColoredNoise('Color','white','SamplesPerFrame',N,'NumChannels',2,'RandomStream','mt19937ar with seed','Seed',rand_s);
d1 = cn1();
d1 = d1*1;
cn2 = dsp.ColoredNoise('Color','white','SamplesPerFrame',N,'NumChannels',2,'RandomStream','mt19937ar with seed','Seed',rand_s+37);
d2 = cn2();
d2 = d2*1;
...
opt = oeOptions;
opt.Display = 'on';
opt.SearchOption.MaxIter = (dim*2+1)*100;
