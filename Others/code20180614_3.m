...
model0_h = arx(data0,[60,61,0],'Display','on','Focus','prediction');
model0 = minreal(balred(ss(model0_h),6));
...
model1_h = arx(data1,[60,61,0],'Display','on','Focus','prediction');
model1 = minreal(balred(ss(model1_h),6));
