...
model0 = n4sid(data0,6,'N4weight','MOESP','Feedthrough',1,'DisturbanceModel','estimate','Form','canonical','InitialState','estimate');
model0 = minreal(model0);
...
model1 = n4sid(data1,6,'N4weight','MOESP','Feedthrough',1,'DisturbanceModel','estimate','Form','canonical','InitialState','estimate');
model1 = minreal(model1);
%% Chracter plot Area
