...
% 組み込みpolyで初期値を求め，その後，組み込み関数Pemによって求める
...
%init_sys0 = arx(data0,[6,7,0],'Display','on');
init_sys0 = armax(data0,[6,7,6,0],'Display','on');
%init_sys0 = oe(data0,[6,6,0],'Display','on');
%init_sys0 = bj(data0,[7,6,6,6,0],'Display','on');
model0_p = pem(data0,init_sys0,'Focus','Prediction');
model0 = ss(model0_p);
...
%init_sys1 = arx(data1,[6,7,0],'Display','on');
init_sys1 = armax(data1,[6,7,6,0],'Display','on');
%init_sys1 = oe(data1,[6,6,0],'Display','on');
init_sys1 = bj(data1,[7,6,6,6,0],'Display','on');
model1_p = pem(data0,init_sys1,'Focus','simulation');
model1 = ss(model1_p);
